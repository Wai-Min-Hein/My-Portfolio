...
const Offering = () => {
  ...
  return (
    <>
        ...
        >
         <section className='grid grid-cols-1 lg:grid-cols-3 md:items-start gap-5'>
            <motion.div
             initial={{x: "-50%"}}
             whileInView={{x : 0}}
             viewport={{once:true}}
             ...
             >
            <ul className='grid grid-rows-2 gap-16 col-span-1'>
                ...
                <li className='text-white uppercase flex items-center justify-center lg:justify-start'>
            ...
            <motion.div
             ...
             className='col-span-2'>
              ...
              <div className="box bg-card-bg rounded-4xl py-6.5 px-7 grid grid-rows-1 grid-cols-2 gap-5">
                ...
                <div className="box pt-6 px-6">
                    ...
                    <p className='text-card-para text-[.95rem] font-medium'>
                ...
                <div className="box pt-6 px-6 pb-7">
