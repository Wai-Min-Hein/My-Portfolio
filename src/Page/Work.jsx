      ...
      <div className="xl:container xl:mx-auto h-auto lg:min-h-screen px-[1rem] md:px-[2rem]  xl:px-[4.5rem]">
        <motion.div
          ...
          className=' grid grid-cols-1 md:mt-20 md:grid-cols-3 gap-5 pt-8  items-center justify-center '>
            <div className=' grid gap-5 col-span-1'>
              ...
              className='  bg-card-bg box p-4 pb-6.5 rounded-4xl cursor-pointer'>
                  ...
                  <div className=' flex items-center justify-between '>
                    ...
                    <span href='https://flowyark.vercel.app/' className='transition duration-300 text-card-para linkicon opacity-20'>
                      <img src={icon} alt="" className=''/>
                    </span>
                  </div>
              </motion.div>
           ...
           <Link to={'https://contact-silk-seven.vercel.app/'} target="_blank">
              <motion.div 
                initial={{ scale: 0.7 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
                ...
                className=' bg-card-bg box p-4 pb-6.5 rounded-4xl cursor-pointer'>
                  ...
                  <div className=' flex items-center justify-between '>
                    ...
                    <span href='https://contact-app-pearl.vercel.app/' className='transition duration-300 text-card-para linkicon opacity-20'>
                      <img src={icon} alt="" className=''/>
                    </span>
                  </div>
              </motion.div>
...
<Link to={'https://pandamr.vercel.app/'} target="_blank">
              <motion.div
                ...
                className=' bg-card-bg box p-4 pb-6.5 rounded-4xl cursor-pointer'>
                  <img className='rounded-4xl mb-4 mt-6 w-full ' src={panda} alt="" />
                  <div className=' flex items-center justify-between mt-6'>
                    <div className=''>
                      <p className='  text-xs uppercase mb-0 text-card-para opacity-50'>Web designing</p>
                      <h6 className='  text-card-para font-medium text-lg'>Panda</h6>
                    </div>
                    <span href='https://pandamr.vercel.app/' className='transition duration-300 text-card-para linkicon opacity-20'>
                      <img src={icon} alt="" className=''/>
                    </span>
                  </div>
              </motion.div>
              ...
              <motion.div
                ...
                className=' bg-card-bg box mt-5 md:mt-0 p-4 pb-6.5 rounded-4xl cursor-pointer'>
                  ...
                  <div className=' flex items-center justify-between '>
                    ...
                    <span href='https://show-now.vercel.app/' className='transition duration-300 text-card-para linkicon opacity-20'>
                      <img src={icon} alt="" className=''/>
                    </span>
                  </div>
              </motion.div>
