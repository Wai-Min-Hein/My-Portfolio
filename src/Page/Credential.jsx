        ...
        <div className="basis-2/3">
          ...
          >
            ...
            <p className="text-white text-[1.1rem]  leading-normal tracking-wide opacity-80 mt-6 mb-9">
              I am a front-end developer who use react.js mainly with a focus on
              web design,state management, appropriate with backend api and
              problem solving.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white opacity-80 text-[1.1rem] leading-normal tracking-wide">
              During my journey as a React developer, I have completed an
              intensive React course and gained practical experience by working
              on various projects. Through these experiences, I have honed my
              skills and demonstrated my ability to create robust and efficient
              web applications.
            </p>
            <p className="text-white opacity-80 text-[1.1rem] leading-normal tracking-wide mt-4">
              I also participated in a two-month workshop focused on enhancing
              my React skills and staying up-to-date with the latest industry
              trends. During the workshop, I explored advanced topics such as
              server-side rendering, performance optimization, and state
          ...
          >
            ...
            <p className="text-white opacity-80 text-[1.1rem] leading-normal tracking-wide">
              I successfully completed my matriculation exam in 2019,
              demonstrating a strong foundation in various subjects, including
              Mathematics, English. This examination provided me with a
              comprehensive understanding of core concepts, critical thinking,
          ...
          >
            ...
            <div className="flex items-center justify-between flex-wrap gap-y-6 mt-8">
              <div className="basis-1/2">
                ...
                <h4 className="text-white text-lg font-normal c capitalize">
                  html
                </h4>
              </div>
              <div className="basis-1/2">
              ...
              <div className="basis-1/2">
                ...
                <h4 className="text-white text-lg font-normal capitalize">
                  tailwind
                </h4>
              </div>
              <div className="basis-1/2">
